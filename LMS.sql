-- Query 1: Add an extra column ‘Late’ to the Book_Loan table. Values will be 0-for non-late retuns, and 1-for late returns.
-- Then update the ‘Late’ column with '1' for all records that have a return date later than the due date
-- and with '0' for those that were returned on time.
